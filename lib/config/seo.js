...
export const SEO_CONFIG = {
	...
	"/examples": {
		title: "Translation Examples — aantraa",
		description:
			"Watch real aantraa video translations side by side — original sources and AI-dubbed output in 90+ languages.",
		keywords:
			"translation examples, video dubbing samples, multilingual dubbing, aantraa demos",
		ogType: "website",
		...BANNER,
	},
	...
	"/app/*": {
		title: "Dashboard — aantraa",
		description: "Manage your aantraa translation projects.",
		noindex: true,
		...BANNER,
	},
	...
	"/features": {
		...
		keywords:
			"video translation, text to audio, AI captions, viral clips, aantraa features",
		ogType: "website",
		...BANNER,
	},
	...
	// Blog routes (nested) — listing; per-post meta is set in pages/blog/[slug].js
	"/blog": {
		title: "Blog — aantraa",
		description:
			"Articles on AI audio and video translation, free starter credits, usage-based pricing, and product updates from aantraa.",
		keywords:
			"aantraa blog, video translation, audio translation, AI dubbing, free credits, pricing",
		ogType: "website",
		...BANNER,
	},
	...
	"/blog/*": {
		title: "Blog — aantraa",
		description:
			"Articles on AI audio and video translation, free starter credits, and usage-based pricing from aantraa.",
		keywords:
			"aantraa blog, video translation, audio translation, AI dubbing",
		ogType: "article",
		...BANNER,
	},
	...
	// Contact
	"/contact": {
		title: "Contact — aantraa",
		description:
			"Get in touch with aantraa for support, pricing, agency APIs, or partnership questions.",
		keywords: "contact aantraa, support, video translation help, agency API",
		ogType: "website",
		...BANNER,
	},
	...
	"/share/*": {
		title: "Shared translation — aantraa",
		description:
			"Watch AI-dubbed video, captions, or viral clips shared from aantraa.",
		keywords: "shared translation, video dubbing, captions, aantraa",
		ogType: "website",
		...BANNER,
	},
