...
export const SEO_CONFIG = {
	// Homepage
	"/": {
		title: "vaantra — AI Video & Voice Translation",
		description:
	...
	// Pricing
	"/pricing": {
		title: "Pricing — vaantra (usage-based)",
		description:
			"Pay only for translation minutes. Top up with Polar and dub video or voice in 90+ languages.",
	...
	"/login": {
		title: "Sign in — vaantra",
		description:
			"Sign in with Google to manage video and voice translation jobs on vaantra.",
		keywords: "login, sign in, Google, vaantra",
